...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizeTecsaTetherAmount") || reset)
        SoftSetArg("-anonymizetecsatetheramount", settings.value("nAnonymizeTecsaTetherAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in tecsatether.cpp during shotdown to also remove the window positions
