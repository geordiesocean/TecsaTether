...
/* TecsaTether GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "TecsaTether"
#define QAPP_ORG_DOMAIN "tecsatether.org"
#define QAPP_APP_NAME_DEFAULT "TecsaTether-Qt"
#define QAPP_APP_NAME_TESTNET "TecsaTether-Qt-testnet"
