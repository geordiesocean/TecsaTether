...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("TecsaTether"),
     ...
     * override -datadir in the tecsatether.conf file in the default data directory
     * (to be consistent with tecsatetherd behavior)
     */
