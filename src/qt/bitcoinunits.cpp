...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case PIV:
        return QString("USDTX");
    case mPIV:
        return QString("mUSDTX");
    case uPIV:
        return QString::fromUtf8("uUSDTX");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZusdtx)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZUSDTX)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZUSDTX);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZUSDTX)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZUSDTX));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
