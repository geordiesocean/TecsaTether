...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            TECSATETHERGUI* window = static_cast<TECSATETHERGUI*>(parentWidget());
...
{
    TECSATETHERGUI* gui = static_cast<TECSATETHERGUI*>(parentWidget());
...
{
    hide();
    static_cast<TECSATETHERGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("TecsaTether will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your USDTXs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
