...
#include "qt/tecsatether/furabstractlistitemdelegate.h"
#include "qt/tecsatether/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/tecsatether/txviewholder.h"
...
#include "config/tecsatether-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    explicit DashboardWidget(TECSATETHERGUI* _window);
    ~DashboardWidget();
