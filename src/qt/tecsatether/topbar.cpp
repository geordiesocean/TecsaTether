...
#include "qt/tecsatether/topbar.h"
#include "askpassphrasedialog.h"
#include "qt/tecsatether/forms/ui_topbar.h"
#include "qt/tecsatether/loadingdialog.h"
#include "qt/tecsatether/lockunlock.h"
#include "qt/tecsatether/qtutils.h"
#include "qt/tecsatether/receivedialog.h"
...
TopBar::TopBar(TECSATETHERGUI* _mainWindow, QWidget* parent) : PWidget(_mainWindow, parent),
                                                        ui(new Ui::TopBar)
{
    ui->setupUi(this);
    ...
    setCssProperty({ui->labelTitle1, ui->labelTitle4, ui->labelTitle5},
  ...
  //                     ui->labelTitle6},
    ...
    setCssProperty({ui->labelImmaturePiv, ui->labelAvailablePiv},
  //  setCssProperty({ui->labelPendingPiv, ui->labelImmaturePiv, ui->labelAvailablePiv},
 //                      ui->labelLockedPiv, ui->labelMasternodeCount, ui->labelCollateralUsdtx,
 //                      ui->labelNextCollateralBlocks, ui->labelNextCollateralValue, ui->labelCollateralUsdtx},
 //                      ui->labelLockedPiv},
        "amount-small-topbar");
...
//    ui->pushButtonFAQ->setButtonText(tr("FAQ"));
    ...
    ui->pushButtonConf->setButtonText("tecsatether.conf");
...
void TopBar::onBtnConfClicked()
{
    ...
    if (!GUIUtil::openConfigfile())
        inform(tr("Unable to open tecsatether.conf with default application"));
}
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("USDTX")
    updateDisplayUnit();
...
void TopBar::refreshStatus()
{
    ...
    // Collateral
 //   ui->labelCollateralUsdtx->setText(GUIUtil::formatBalance(CMasternode::GetMasternodeNodeCollateral(chainActive.Tip()->nHeight), nDisplayUnit));
}
