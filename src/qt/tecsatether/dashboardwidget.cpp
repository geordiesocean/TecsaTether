...
#include "qt/tecsatether/forms/ui_dashboardwidget.h"
#include "qt/tecsatether/sendconfirmdialog.h"
#include "qt/tecsatether/txrow.h"
...
DashboardWidget::DashboardWidget(TECSATETHERGUI* parent) :
    PWidget(parent),
...
void DashboardWidget::loadWalletModel()
{
 ...
 //       connect(ui->pushImgEmpty, &QPushButton::clicked, window, &TECSATETHERGUI::openFAQ);
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair USDTX, zUSDTX
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(67,188,153));
	set1->setColor(QColor(67,188,153));
