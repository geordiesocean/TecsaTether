...
#ifndef TECSATETHER_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define TECSATETHER_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //TECSATETHER_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
