...
#include "qt/tecsatether/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(TECSATETHERGUI* _window, QWidget *parent) :
