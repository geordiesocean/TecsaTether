...
#include "qt/tecsatether/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/tecsatether/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(TECSATETHERGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    if (parent)
        connect(parent, &TECSATETHERGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
