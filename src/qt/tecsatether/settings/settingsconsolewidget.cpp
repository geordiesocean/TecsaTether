...
#include "qt/tecsatether/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/tecsatether/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(TECSATETHERGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("<u>Welcome to the USDTX RPC console.</u>") + "<br>" +
