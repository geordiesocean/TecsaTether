...
#include "qt/tecsatether/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/tecsatether/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(TECSATETHERGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to TECSATETHERGUI::handleRestart()
