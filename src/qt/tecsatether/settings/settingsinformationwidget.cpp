...
#include "qt/tecsatether/settings/forms/ui_settingsinformationwidget.h"
...
SettingsInformationWidget::SettingsInformationWidget(TECSATETHERGUI* _window,QWidget *parent) :
