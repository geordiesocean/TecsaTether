...
#include "qt/tecsatether/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(TECSATETHERGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("TecsaTether_tx_csv_export(*.csv)") : tr("TecsaTether_addresses_csv_export(*.csv)"),
                                        nullptr);
