...
#include "qt/tecsatether/settings/settingsnetworkwidget.h"
#include "qt/tecsatether/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/tecsatether/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(TECSATETHERGUI* _window, QWidget *parent) :
