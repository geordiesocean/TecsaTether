...
#include "qt/tecsatether/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(TECSATETHERGUI* parent) :
    PWidget(parent),
...
//    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &TECSATETHERGUI::openFAQ);
