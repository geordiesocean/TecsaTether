...
#include "qt/tecsatether/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/tecsatether/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(TECSATETHERGUI* _window, QWidget *parent) :
