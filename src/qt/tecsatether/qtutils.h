...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, TECSATETHERGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, TECSATETHERGUI* gui, double posX = 3);
