...
#include "qt/tecsatether/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(TECSATETHERGUI *mainWindow, QWidget *parent) :
...
//    btns = {ui->btnDashboard, ui->btnSend, ui->btnReceive, ui->btnAddress, ui->btnMaster, ui->btnSettings};
    btns = {ui->btnDashboard, ui->btnSend, ui->btnReceive, ui->btnAddress, ui->btnSettings};
