...
#include "qt/tecsatether/sendcustomfeedialog.h"
#include "qt/tecsatether/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(TECSATETHERGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &TECSATETHERGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
