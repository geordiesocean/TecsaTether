...
/** Utility functions used by the TecsaTether Qt UI.
 */
namespace GUIUtil
{
...
// Render USDTX addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZusdtx = false);
...
// Parse "tecsatether:" URI into recipient object, return true on successful parsing
