...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TecsaTether tecsatether-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tecsatether-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tecsatether transaction") + "\n" +
                               "  tecsatether-tx [options] -create [commands]   " + _("Create hex-encoded tecsatether transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tecsatether transaction
