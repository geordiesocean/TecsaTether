...
#ifndef TECSATETHER_STAKEINPUT_H
#define TECSATETHER_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZUSDTX() const = 0;
    virtual CDataStream GetUniqueness() const = 0;
    virtual bool ContextCheck(int nHeight, uint32_t nTime) = 0;
};


class CUsdtxStake : public CStakeInput
{
private:
...
public:
    ...
    bool IsZUSDTX() const override { return false; }
    bool ContextCheck(int nHeight, uint32_t nTime) override;
};


#endif //TECSATETHER_STAKEINPUT_H
