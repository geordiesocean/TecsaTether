...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"tecsatether", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"tecsatether", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"tecsatether", "masternodecurrent", &masternodecurrent, true },
        {"tecsatether", "startmasternode", &startmasternode, true },
        {"tecsatether", "createmasternodekey", &createmasternodekey, true },
        {"tecsatether", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"tecsatether", "listmasternodeconf", &listmasternodeconf, true },
        {"tecsatether", "getmasternodestatus", &getmasternodestatus, true },
        {"tecsatether", "getmasternodewinners", &getmasternodewinners, true },
        {"tecsatether", "getmasternodescores", &getmasternodescores, true },
        {"tecsatether", "preparebudget", &preparebudget, true },
        {"tecsatether", "submitbudget", &submitbudget, true },
        {"tecsatether", "mnbudgetvote", &mnbudgetvote, true },
        {"tecsatether", "getbudgetvotes", &getbudgetvotes, true },
        {"tecsatether", "getnextsuperblock", &getnextsuperblock, true },
        {"tecsatether", "getbudgetprojection", &getbudgetprojection, true },
        {"tecsatether", "getbudgetinfo", &getbudgetinfo, true },
        {"tecsatether", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"tecsatether", "mnfinalbudget", &mnfinalbudget, true },
        ...
        {"zerocoin", "getzusdtxseed", &getzusdtxseed, false },
        {"zerocoin", "setzusdtxseed", &setzusdtxseed, false },
        {"zerocoin", "generatemintlist", &generatemintlist, false },
        {"zerocoin", "searchdzusdtx", &searchdzusdtx, false },
        {"zerocoin", "dzusdtxstate", &dzusdtxstate, false },
...
{
    return "> tecsatether-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user usdtxername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:10025/\n";
}
