...
extern UniValue DoZusdtxSpend(const CAmount nAmount, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str);
...
extern UniValue setzusdtxseed(const JSONRPCRequest& request);
extern UniValue getzusdtxseed(const JSONRPCRequest& request);
extern UniValue generatemintlist(const JSONRPCRequest& request);
extern UniValue searchdzusdtx(const JSONRPCRequest& request);
extern UniValue dzusdtxstate(const JSONRPCRequest& request);
