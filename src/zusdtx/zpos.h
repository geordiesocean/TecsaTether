...
#ifndef TECSATETHER_LEGACY_ZPOS_H
#define TECSATETHER_LEGACY_ZPOS_H

#include "stakeinput.h"
#include "main.h"
#include "txdb.h"

class CLegacyZUsdtxStake : public CStakeInput
{
private:
    uint32_t nChecksum;
...
public:
    ...
    explicit CLegacyZUsdtxStake(const libzerocoin::CoinSpend& spend);
    bool InitFromTxIn(const CTxIn& txin) override;
    bool IsZUSDTX() const override { return true; }
...
#endif //TECSATETHER_LEGACY_ZPOS_H
