...
#ifndef TECSATETHER_ZUSDTXTRACKER_H
#define TECSATETHER_ZUSDTXTRACKER_H
...
public:
    CzUSDTXTracker(CWallet* parent);
    ~CzUSDTXTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzUSDTXWallet* zUSDTXWallet = NULL);
...
#endif //TECSATETHER_ZUSDTXTRACKER_H
