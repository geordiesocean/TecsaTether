...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/tecsatether-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/tecsatether-cli.cpp \
           src/tecsatether-tx.cpp \
           src/tecsatether.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/tecsatether.qrc src/qt/tecsatether_locale.qrc

TRANSLATIONS += src/qt/locale/tecsatether_bg.ts \
                src/qt/locale/tecsatether_de.ts \
                src/qt/locale/tecsatether_en.ts \
                src/qt/locale/tecsatether_es.ts \
                src/qt/locale/tecsatether_fi.ts \
                src/qt/locale/tecsatether_fr.ts \
                src/qt/locale/tecsatether_it.ts \
                src/qt/locale/tecsatether_ja.ts \
                src/qt/locale/tecsatether_pl.ts \
                src/qt/locale/tecsatether_pt.ts \
                src/qt/locale/tecsatether_ru.ts \
                src/qt/locale/tecsatether_sk.ts \
                src/qt/locale/tecsatether_sv.ts \
                src/qt/locale/tecsatether_vi.ts \
                src/qt/locale/tecsatether_zh_CN.ts \
                src/qt/locale/tecsatether_zh_TW.ts
