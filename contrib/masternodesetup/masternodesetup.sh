...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='tecsatether.conf'
CONFIGFOLDER='/root/.tecsatether'
COIN_DAEMON='tecsatetherd'
COIN_CLI='tecsatether-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/TecsaTetherNetwork/TecsaTether/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='tecsatether'
COIN_PORT=10024
RPC_PORT=10025
...
addnode=seed03.tecsatether.com
addnode=seed04.tecsatether.com
addnode=seed05.tecsatether.com
addnode=seed06.tecsatether.com
addnode=seed07.tecsatether.com
addnode=seed08.tecsatether.com
addnode=seed09.tecsatether.com
addnode=seed10.tecsatether.com
