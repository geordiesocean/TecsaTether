...
#define MyAppName "TecsaTether"
#define MyAppPublisher "2022 TecsaTether developers"
#define MyAppURL "https://tecsatether.com/"
#define MyAppExeName "tecsatether-qt.exe"
//#define MyAppExtraData "https://explorer.tecsatether.com/bootstraps/USDTX/bootstrap.zip"
...
DefaultDirName={autopf}\TecsaTether
...
OutputDir=.\output
OutputBaseFilename=TecsaTetherSetup
...
DefaultGroupName=TecsaTether Core
...
[Files]
Source: ".\package\tecsatether-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\TecsaTether\TecsaTether-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\TecsaTether\TecsaTether-Qt,strDataDir|{userappdata}\TecsaTether\}');
  Result := True;
end;
